<%@ Page Title="" Language="C#" MasterPageFile="~/cust.master" AutoEventWireup="true" CodeFile="addListing.aspx.cs" Inherits="addListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <strong><h1>Create Listing</h1></strong>
  <!-- One "tab" for each step in the form: -->
  <div class="tab"><h2>STEP 1: Upload Photos</h2>
      <div class="row">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
				...
				<div class="col-xs-4"><img id="blah" height="150" src="https://via.placeholder.com/150" width="auto" alt="your image" /></div>
			</div>  

     
    
  </div>
  <div class="tab"><h2>STEP 2: Choose a category</h2>
      <br />
  ...
  <div class="tab"><h2>STEP 3: Basic details</h2>
  ...
  <div style="overflow:auto;">
    <div style="float:right;">
      ...
      <button type="button" id="nextBtn" onclick="nextPrev(1)">Next</button>
        <div id="myDIV">
            <asp:Button ID="btn_Insert" class="btn_Insert1" runat="server" OnClick="btn_Insert_Click" Text="List it!" />
        </div>
    </div>
  </div>
...
function showTab(n) {
    var submitbutton = document.getElementById("myDIV");
