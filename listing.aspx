<%@ Page Title="" Language="C#" MasterPageFile="~/cust.master" AutoEventWireup="true" CodeFile="listing.aspx.cs" Inherits="listing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="breadcrumb" role="navigation" aria-label="Breadcrumbs">
    <div class="_cont">
      <ol>
        <li><a title="Back to the frontpage" href="listingCatalog.aspx">Home</a></li>
        <%--<li><a title=""></a></li>--%>
        ...
        <div class="cols">
          <div class="left-col">
            <div class="thumbs">
              <a class="thumb-image active" data-index="0">
                <span><asp:Image ID="img_Products" runat="server" alt="Tommy Hilfiger T-Shirt New York"/></span>
              </a>
            ...
            <div class="big">
              <span><asp:Image ID="Image1" runat="server" alt="Tommy Hilfiger T-Shirt New York"/></span>
          ...
          <div class="right-col">
              ...
              <span id="status_span" runat="server" style="padding:5px;font-size:30px;">
                  ...
                  <asp:Label ID="listingstatus_lbl" runat="server" Text="Status"></asp:Label>
              </span>
                    <asp:Button ID="edit_btn" OnClick="edit_btn_Click" style="margin-left:5px"  class="btn btn-warning" runat="server" Text="Edit" />
                  </h1>
            <h1 itemprop="name">
        <asp:Label ID="lbl_listingname" runat="server" Text="Label"></asp:Label></h1>
            <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
              ...
              <div class="price-shipping">
                ...
                <div class="price" id="price-preview" quickbeam="price" quickbeam-price="800">
                  <div style="font-size:20px;">Budget</div>$<asp:Label ID="lbl_price" runat="server" Text="Budget"></asp:Label>
                </div>
                  <br />
                <a>Free shipping</a>
              </div>
              ...
              <%--<form id="AddToCartForm">
                ...
                <br />
<%--        <a href="#" class="btn btn-info btn-lg" style="text-decoration:none;color:white">
          <span class="glyphicon glyphicon-hand-up"></span> Bid
        </a>--%>
<asp:Button ID="bid_btn" runat="server" class="btn btn-info btn-lg" Text="Bid" OnClick="bid_btn_Click" />
              <div class="tabs">
                ...
                <div class="tab-slides">
                  <div id="tab-slide-1" itemprop="description"  class="slide active">
                    ...
                    <p><strong>Listing ID: </strong><asp:Label ID="listingID" runat="server" Text="ListingID"></asp:Label></p>
                 
                    
                    <p><strong>Average bidding</strong> $<asp:Label ID="Label2" runat="server" Text="avg bid"></asp:Label></p>
                    <p><strong>Number of bidding</strong> <asp:Label ID="Label3" runat="server" Text="avg bid"></asp:Label></p>
                    <p><strong>Posted by: </strong> <asp:Label ID="custEmaillbl" runat="server" Text="avg bid"></asp:Label></p>
    ...
    <li class="active"><a style="text-decoration:none;">Current Biddings</a></li>
       </ul>
      <br />
        ...
        <ItemTemplate>
            <div class="col-md-4">
                  <div class="well dash-box"><!--THUMBNAIL#2-->
                     <div class="row">
                        <%--<asp:ImageButton ID="img_Products" runat="server" ImageUrl='<%# Eval("Listing_Img") %>' Height="215px" Width="246px"/>--%>
                      <div class="col-8">
                        <strong><asp:Label ID="ListingBid_ID_lbl" runat="server" Text='<%# Eval("ListingBid_ID") %>'></asp:Label></strong>
                    
         <br />
                        <strong><asp:Label ID="lbl_ProdName" runat="server" Text='<%# Eval("BakerEmail") %>'></asp:Label></strong>
                        <br />

                    
                           <asp:Label ID="bidprice" runat="server" Text='<%# Eval("ListingBidPrice") %>'></asp:Label>
                   
            <asp:Label ID="lbl_ProdID" runat="server" Text='<%# Eval("ListingBidStatus") %>'></asp:Label>
            <br />
                          </div>
                         <div class="col-4">
                             <asp:Button ID="accept_btn" runat="server" OnClick="accept_btn_Click" class="btn btn-success" Text="Accept" />
                             <asp:Button ID="decline_btn" runat="server" OnClick="decline_btn_Click" class="btn btn-danger" Text="Decline" />
                         </div>
